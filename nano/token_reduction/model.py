...
class TrainerDeepSeekMTP(TrainerMTP):
    ...
    def mtp_recursive(
        ...
        embedding_outputs_mtp = embedding_outputs[:, mtp_head_num + 1 : seq_len_with_mtp - n_mtp]
        block_out = self.model.mtp_modules[mtp_head_num - 1](embedding_outputs_mtp, prev_block_out_detached)
        ...
        mtp_target_ids = target_ids[:, mtp_head_num + 1 : seq_len_with_mtp - n_mtp].detach()
