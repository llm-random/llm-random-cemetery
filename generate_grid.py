...
BASELINE_GRAD_MODIF_PLACEMENT = (["post_attn", "post_attn_norm", "post_attn_add", "post_ff", "post_ff_norm", "post_ff_add"], "all")
BASELINE_STD_NORM_MODIF_PARAMS = (["layer_type=v1", "c=0.0", "eps=0.0"], "baseline")

LR_MULTIPLIERS: List[Tuple[float, str]] = [(1/100, "div100"), (1/30, "div30"), (1/10, "div10"), (1/3, "div3"), (1, "mul1"), (3, "mul3"), (10, "mul10")]
