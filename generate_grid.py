...
OUTPUT_FILE = "configs/experiments/grad_norm/std_norm_grid/c_lr_placement_dims_grid_scale_norm_short.yaml"
...
NAME_PREFIX = "scale_norm_c_lr_dims_grid_placement_short"
    ...
    for i, ((lr_multiplier, lr_tag), (c, c_tag), (placement, placement_tag), (norm_dims, nd_tag)) in enumerate(itertools.product(LR_MULTIPLIERS, C_GRID, GRAD_MODIF_PLACEMENT_COMBINATIONS, NORM_DIMS)):
        ...
        config = {
            ...
            "params": {
                ...
                "grad_modif_params": ["k=1", f"c={c}", "eps=0", f"norm_dims={norm_dims}"],
                "tags": [f"lr_{lr_tag}", "scale_norm", "scale_norm_c_lr_grid_placement_short", "grad_norm", c_tag, placement_tag, nd_tag],
