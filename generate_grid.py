...
OUTPUT_FILE = "configs/experiments/grad_norm/std_norm_grid/c_lr_placement_grid_std_v1_short_cont.yaml"
...
NAME_PREFIX = "std_v1_c_lr_grid_placement_short"
...
def main():
    ...
    for i, ((lr_multiplier, lr_tag), (c, c_tag), (placement, placement_tag)) in enumerate(itertools.product(LR_MULTIPLIERS, C_GRID, GRAD_MODIF_PLACEMENT_COMBINATIONS)):
        ...
        config = {
            ...
            "params": {
                ...
                "tags": [f"lr_{lr_tag}", "std_norm", "std_v1_c_lr_grid_placement_short", "grad_norm", c_tag, placement_tag],
    ...
    '''
    offset = len(C_GRID) * len(LR_MULTIPLIERS) * len(GRAD_MODIF_PLACEMENT_COMBINATIONS)
    for i, (lr_mul, lr_tag) in enumerate(LR_MULTIPLIERS, start=offset):
