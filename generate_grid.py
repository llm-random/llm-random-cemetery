...
OUTPUT_FILE = "configs/experiments/grad_norm/std_norm_grid/post_add_c_lr_grid_reduced_bn.yaml"
...
def main():
    ...
    for i, ((lr_multiplier, lr_tag), (c, c_tag)) in enumerate(itertools.product(LR_MULTIPLIERS, C_GRID)):
        ...
        config = {
            ...
            "params": {
                "grad_modif_placement": ["post_add"],
                "grad_modif_params": ["layer_type=v1", f"c={c}", "eps=1e-6"],
                "tags": [f"lr_{lr_tag}", "std_norm", "post_add_c_lr_grid", "grad_norm", c_tag],
    ...
    for i, (lr_mul, lr_tag) in enumerate(LR_MULTIPLIERS, start=len(C_GRID)*len(LR_MULTIPLIERS)):
        ...
        config = {
            ...
            "params": {
                ...
                "grad_modif_params": ["layer_type=v1", "c=99", "eps=1e-6"],
                "tags": [f"lr_{lr_tag}", "std_norm", "post_add_c_lr_grid", "grad_norm", "true_baseline"],
                "name": f"{NAME_PREFIX}_{config_name}",
                "grad_modif_type": "std_norm",
