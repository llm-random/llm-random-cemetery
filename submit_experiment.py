...
EXPERIMENTS_CEMETERY_DIRECTORY="experiments_cemetery" #TODO(crewtool) move to constants
...
def submit_experiment(hostname, experiment_branch_name, experiment_config_path):
    ...
    experiment_directory = f"~/{EXPERIMENTS_CEMETERY_DIRECTORY}/{experiment_branch_name}" #TODO make sexperiments_cemetery exists
...
if __name__ == "__main__":
    ...
    group.add_argument(
        "--experiment", type=str, help="[Optional] Name of the existing branch on cemetery to run experiment."
    )
    group.add_argument(
        "--config",
        type=str,
