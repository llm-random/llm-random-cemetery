...
def glue_split_collate_wrapper(examples):
    ...
    #         collated_examples.append(None)
    #         continue
    #     collated_examples.append(glue_collate_wrapper(example))
    return [glue_collate_wrapper(example) if example[0] is not None else None for example in zip(*examples)]
