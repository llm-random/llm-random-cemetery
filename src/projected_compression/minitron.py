...
def prune(model: nn.Module, dmodel_indices, dff_indices):
    ...
    for block in model.encoder.blocks:
        ...
        block.ff_layer.layer.ff_pre_act.weight.data = block.ff_layer.layer.ff_pre_act.weight[dff_indices, dmodel_indices]
        block.ff_layer.layer.gate.weight.data = block.ff_layer.layer.gate.weight[dff_indices, dmodel_indices]
