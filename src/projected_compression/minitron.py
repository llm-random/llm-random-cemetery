...
def prune(model: nn.Module, dmodel_indices, dff_indices):
    ...
    for block in model.encoder.blocks:
        ...
        # Attention layer
        print(f"block.attention_layer.norm.weight.data shape: {block.attention_layer.norm.weight.data.shape}")
        print(f"block.attention_layer.layer.q_proj.weight.data shape: {block.attention_layer.layer.q_proj.weight.data.shape}")
        print(f"block.attention_layer.layer.k_proj.weight.data shape: {block.attention_layer.layer.k_proj.weight.data.shape}")
        print(f"block.attention_layer.layer.v_proj.weight.data shape: {block.attention_layer.layer.v_proj.weight.data.shape}")
        print(f"block.attention_layer.layer.o_proj.weight.data shape: {block.attention_layer.layer.o_proj.weight.data.shape}")

        block.attention_layer.norm.weight.data = block.attention_layer.norm.weight.data[dmodel_indices]
        block.attention_layer.layer.q_proj.weight.data = block.attention_layer.layer.q_proj.weight.data[:, dmodel_indices]
        block.attention_layer.layer.k_proj.weight.data = block.attention_layer.layer.k_proj.weight.data[:, dmodel_indices]
        block.attention_layer.layer.v_proj.weight.data = block.attention_layer.layer.v_proj.weight.data[:, dmodel_indices]
        block.attention_layer.layer.o_proj.weight.data = block.attention_layer.layer.o_proj.weight.data[dmodel_indices, :]

        # FF layer
        print(f"block.ff_layer.norm.weight.data shape: {block.ff_layer.norm.weight.data.shape}")
        print(f"block.ff_layer.layer.ff_pre_act.weight.data shape: {block.ff_layer.layer.ff_pre_act.weight.data.shape}")
        print(f"block.ff_layer.layer.gate.weight.data shape: {block.ff_layer.layer.gate.weight.data.shape}")
        print(f"block.ff_layer.layer.ff_post_act.weight.data shape: {block.ff_layer.layer.ff_post_act.weight.data.shape}")

        block.ff_layer.norm.weight.data = block.ff_layer.norm.weight.data[dmodel_indices]
        block.ff_layer.layer.ff_pre_act.weight.data = block.ff_layer.layer.ff_pre_act.weight.data[dff_indices, dmodel_indices]
        block.ff_layer.layer.gate.weight.data = block.ff_layer.layer.gate.weight.data[dff_indices, dmodel_indices]
        block.ff_layer.layer.ff_post_act.weight.data = block.ff_layer.layer.ff_post_act.weight.data[dmodel_indices, dff_indices]
