...
def prune(model: nn.Module, dmodel_indices, dff_indices):
    ...
    for block in model.encoder.blocks:
        ...
        block.attention_layer.norm.normalized_shape = 3072
        ...
        block.ff_layer.norm.normalized_shape = 3072
...
def minitron_prune(model: nn.Module, dataloader, dmodel, dff, calibration_dataset_size, seq_len):
    ...
    dict_to_save = {"dmodel_top_indices": dmodel_top_indices.tolist(), "dff_top_indices": dff_top_indices.tolist()}
    path = "./top_indices.txt"
