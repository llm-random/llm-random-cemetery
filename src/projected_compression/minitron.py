...
def prune(model: nn.Module, dmodel_indices, dff_indices):
    ...
    for block in model.encoder.blocks:
        ...
        block.ff_layer.layer.ff_pre_act.weight.data = block.ff_layer.layer.ff_pre_act.weight.data[dmodel_indices, dff_indices]
        block.ff_layer.layer.gate.weight.data = block.ff_layer.layer.gate.weight.data[dmodel_indices, dff_indices]
        block.ff_layer.layer.ff_post_act.weight.data = block.ff_layer.layer.ff_post_act.weight.data[dff_indices, dmodel_indices]
