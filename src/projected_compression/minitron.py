...
def prune(model: nn.Module, dmodel_indices, dff_indices):
    ...
    for block in model.encoder.blocks:
        ...
        block.attention_layer.norm.weight = block.attention_layer.norm.weight[dmodel_indices]
        block.attention_layer.layer.q_proj.weight = block.attention_layer.layer.q_proj.weight[:, dmodel_indices]
        block.attention_layer.layer.k_proj.weight = block.attention_layer.layer.k_proj.weight[:, dmodel_indices]
        block.attention_layer.layer.v_proj.weight = block.attention_layer.layer.v_proj.weight[:, dmodel_indices]
        block.attention_layer.layer.o_proj.weight = block.attention_layer.layer.o_proj.weight[dmodel_indices, :]
        ...
        block.ff_layer.norm.weight = block.ff_layer.norm.weight[dmodel_indices]
        block.ff_layer.layer.ff_pre_act.weight = block.ff_layer.layer.ff_pre_act.weight[dff_indices, dmodel_indices]
        block.ff_layer.layer.gate.weight = block.ff_layer.layer.gate.weight[dff_indices, dmodel_indices]
        block.ff_layer.layer.ff_post_act.weight = block.ff_layer.layer.ff_post_act.weight[dmodel_indices, dff_indices]
