    ...
    def pass_gradient_to_projections(
        ...
        if optimizers is None:
            ...
            if gradient_clipping:
                params_with_grad = [v for v in self.parameters() if v.grad is not None]
                torch.nn.utils.clip_grads_with_norm_(params_with_grad, gradient_clipping, final_grad_norm)
