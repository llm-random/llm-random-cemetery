    ...
    def init_projections(
        ...
        if smart_init:
            ...
            if self.result_in_features is not None:
                ...
                # self.projection_in_weight = nn.Parameter(weight, requires_grad=True)  #dev SWITCH
            ...
            if self.result_out_features is not None:
                ...
                # self.projection_out_weight = nn.Parameter(weight, requires_grad=True)  #dev SWITCH
