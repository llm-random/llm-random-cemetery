...
class ProjectedLinear(nn.Module):
    ...
    def init_projections(
        ...
        if smart_init:
            print("SMART P1 P2 - mpp") #dev
            # p1, p2 = smart_projections(self.weight, proj_out_topk_indices, proj_in_topk_indices, mpp) # svd_g, mpp
            p1, p2 = smart_projections(self.weight, proj_out_topk_indices, proj_in_topk_indices, svd_g) # svd_g, mpp
            # p1, p2 = smart_projections(self.weight.to("cpu"), proj_out_topk_indices, proj_in_topk_indices, svd_g) # svd_g, mpp
            print("after smart_projections") #dev
            ...
            print("after projection_in_weight") #dev
            ...
            print("after projection_out_weight") #dev
        else:
            if self.result_in_features is not None:
                weight = torch.zeros(
                    self.base_in_features, self.result_in_features, **factory_kwargs
