...
class ProjectedLinear(nn.Module):
    ...
    def init_projections(
        ...
        self.weight =  nn.Parameter(transfer_selected(self.weight, occlusion_weight, proj_in_topk_indices, proj_out_topk_indices)) #dev
...
class ProjectedEmbedding(nn.Module):
    ...
    def init_projection(self, topk_dmodel_indices, smart_init, **factory_kwargs):
        ...
        self.embedding.weight =transfer_selected(self.embedding.weight, occlusion_weight, proj_in_topk_indices, proj_out_topk_indices) #dev
