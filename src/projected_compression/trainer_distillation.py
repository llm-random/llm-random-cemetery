...
from .trainer_distillation import TrainerDistillation

logger = logging.getLogger(__name__)

@define(slots=False)
class PCTrainer(TrainerDistillation):
    ...
    def train(self):
        for step, batch in zip(
            ...
            # This calls TrainerDistillation.calculate_loss which handles 
            # accumulation chunks and .backward() logic internally.
            loss = self.calculate_loss(batch)

            # PC-specific gradient handling
