...
class RepeatedScheduler:
    ...
    def __init__(self, base_scheduler, num_cycles):
        ...
        if hasattr(base_scheduler, 'func'):
            # It's a partial, modify the n_steps keyword argument
            if 'n_steps' in base_scheduler.keywords:
                original_n_steps = base_scheduler.keywords['n_steps']
                base_scheduler.keywords['n_steps'] = original_n_steps // num_cycles
