...
def run(cfg, metric_logger=None):
    ...
    if isinstance(metric_logger, NeptuneLogger) and (training_state["run_id"] is None and not instantiate(cfg.infrastructure.metric_logger, _convert_="all").new_neptune_job):
