...
def main(gradient_checkpointing:bool, group_sizes: [int], models:[str], report_files: [str], output_file):
    params_per_model = {}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_file", default="gpu_max_batch_size_report.csv", type=str)
