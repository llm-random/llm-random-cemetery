...
class AbstractLogger(ABC):
    ...
    def init_job_metadata(self, trining_step:int):
        self.report_text(self.TITLE_JOB_STATE, self.STATE_JOB_RUNNING, trining_step)
        ...
        for to_log in text_logs:
            self.report_text(f"env/{to_log[0]}", to_log[0], trining_step)

    def exit_job_metadata(self, trining_step:int):
        self.report_text(self.TITLE_JOB_STATE, self.STATE_JOB_FINISHED, trining_step)
