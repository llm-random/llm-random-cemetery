...
class AbstractLogger(ABC):
    TITLE_JOB_STATE = "slurm_job_state"
    ...
    def start_job_metadata(self, trining_step:int):
        print("Entered start job metadata logging ------------------------------------------------------------------------------------")#dev
        print(self.TITLE_JOB_STATE, self.STATE_JOB_RUNNING) #dev
        self.report_text(title=self.TITLE_JOB_STATE, value=self.STATE_JOB_RUNNING, iteration=trining_step)
        ...
        for to_log in text_logs.items():
            print(f"env/{to_log[0]}", to_log[1]) #dev
            self.report_text(title=f"env/{to_log[0]}", value=to_log[1], iteration=trining_step)

    def exit_job_metadata(self, trining_step:int):
        print("Entered end job metadata logging ------------------------------------------------------------------------------------")#dev
        print(self.TITLE_JOB_STATE, self.STATE_JOB_FINISHED) #dev
        self.report_text(title=self.TITLE_JOB_STATE, value=self.STATE_JOB_FINISHED, iteration=trining_step)
