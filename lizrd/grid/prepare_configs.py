...
def prepare_configs(
    ...
    for config in configs:
        ...
        config["params"]["train_dataset_path"] = (
            config["params"].get("train_dataset_path") or config["train_dataset_path"]
        )
        config["params"]["validation_dataset_path"] = (
            config["params"].get("validation_dataset_path")
            or config["validation_dataset_path"]
        )
