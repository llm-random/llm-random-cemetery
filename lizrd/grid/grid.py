    ...
    for setup_args, trainings_args in grid:
        for i, training_args in enumerate(trainings_args):
            ...
            with open(full_config_path, "w") as f:
                print("------------------------------------------------------") #dev
                training_args["save_weights_path"] = pathlib.Path(training_args["save_weights_path"])/f"{i}"
                training_args["load_weights_path"] = pathlib.Path(training_args["load_weights_path"])/f"{i}"
