...
class Residual(LoggingLayer):
    ...
    def log_heavy(self):
        ...
        update_to_residual_ratio = update_norms_mean / residual_norms_mean
        ...
        return {
            ...
            "update_to_residual_ratio_mean": update_to_residual_ratio_mean,
            "update_to_residual_ratio_std": update_to_residual_ratio_std,
        }
