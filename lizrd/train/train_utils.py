...
def get_model(
    ...
    print(f"projected_checkpoint: {type(projected_checkpoint)}") #dev
    if projected_checkpoint is not None:
        ...
        load_projected_weights(model, projected_checkpoint["model"], projection, dm, projected_dmodel, init_scale)
