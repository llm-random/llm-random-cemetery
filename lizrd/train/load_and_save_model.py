...
from lizrd.train.checkpoints_manager import CM_LOG_SAVE
...
def get_checkpoint_from_path(load_weights_path: str, logger: Optional[AbstractLogger]) -> str:
