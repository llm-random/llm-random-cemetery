...
def version_code(
    ...
    try:
        ...
        logger.info(f"Experiment pushed to:  '{git_ssh_to_https_tree(remote_url)}/{experiment_branch_name}'")
    finally:
        logger.error(f"Failed to push experiment code to branch '{experiment_branch_name}' at '{remote_url}'")
