...
class MultiheadFlashDiff1(LoggingLayer):
    ...
    def forward(
        ...
        if self.adapter_type == "lora":
            ...
            lora_q = self.lowrank_q.w1 @ self.lowrank_q.w2
            numerator_q = self.q_proj.weight + self.lora_q.T
            ...
            lora_k = self.lowrank_k.w1 @ self.lowrank_k.w2
            numerator_k = self.k_proj.weight + self.lora_k.T
