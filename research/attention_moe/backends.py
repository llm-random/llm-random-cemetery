...
def get_machine_backend(
    ...
    if node == "asusgpu0":
        ...
        is_a100 = get_env_var(connection, "LC_USE_A100") == "1"
        is_h100 = get_env_var(connection, "LC_USE_H100") == "1"
        ...
        if is_a100:
            ...
            # shouldn't happen
            raise ValueError(
                "Set either LC_USE_A100 or LC_USE_H100 (as in `LC_USE_A100=1 ./scripts/run_exp_remotely.sh entropy config.yaml`)"
            )
    elif "athena" in node:
