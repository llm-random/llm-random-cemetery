...
class TokenChoiceMoMQA(LoggingLayer):
    def __init__(
        ...
        **_,
        ...
        self.attention_scalar_inside = torch.nn.Parameter(
            torch.tensor([1 / math.sqrt(self.dhead)])
        )
    ...
    def forward(self, x: torch.Tensor):
        ...
        y = torch.nn.functional.scaled_dot_product_attention(
            ...
            scale=self.attention_scalar_inside.item() if self.scale_attention_inside else None,
        ).transpose(1, 2)
