...
def initialize_compressor(model:torch.nn.Module, projected_weights:dict, dmodel:int, projected_dmodel:int, projection:Union[torch.Tensor, str], projection_mask:torch.Tensor):
    ...
    for name, params in model_grouped[embedding_layer_tag]:
    ...
    for block_id, block_params in model_grouped[encode_block_tag]:
        # print("**************************************************************************************************************************************************************************************************************************************************************************") #dev
        ...
        block_params["block.residual_attention.layer.attention.input_projection_q.projected_weight.weight"].data.copy_(input_projections[0])
        block_params["block.residual_attention.layer.attention.input_projection_k.projected_weight.weight"].data.copy_(input_projections[1])
        block_params["block.residual_attention.layer.attention.input_projection_v.projected_weight.weight"].data.copy_(input_projections[2])
        block_params["block.residual_attention.layer.attention.output_projection.output_projection.weight"].data.copy_(projected_weights[encode_block_tag+block_id+"."+"block.residual_attention.layer.attention.output_projection.weight"])
        block_params["block.residual_feedforward.layer.feedforward.logging_ff_pre_relu.weight"].data.copy_(projected_weights[encode_block_tag+block_id+"."+"block.residual_feedforward.layer.feedforward.logging_ff_pre_relu.weight"])
        block_params["block.residual_feedforward.layer.feedforward.logging_ff_post_relu.weight"].data.copy_(projected_weights[encode_block_tag+block_id+"."+"block.residual_feedforward.layer.feedforward.logging_ff_post_relu.weight"])
