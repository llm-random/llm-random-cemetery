...
class ProjectedAttention(LoggingLayer):
    def __init__(
        ...
        self.input_projection_out_projection_q_add = nn.Sequential(
            OrderedDict([
                ("input_projection_p12_q",
                Linear(
                    projected_dmodel, # xb
        ...
        self.input_projection_out_projection_k_add = nn.Sequential(
            OrderedDict([
                ("input_projection_p12_k_add",
                Linear(
                    projected_dmodel, # xb
                    dmodel, # xs
                    bias=False,
        ...
        self.input_projection_out_projection_v_add = nn.Sequential(
            OrderedDict([
                ("input_projection_p12_v_add",
                Linear(
                    projected_dmodel, # xb
                    dmodel, # xs
                    bias=False,
