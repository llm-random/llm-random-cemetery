...
def plot_loss_vs_lr(runs_table, ylim=None, title=None, figsize=(10, 6), ax=None):
    ...
    for model_width in model_widths:
        ...
        if ax is None:
            ...
            plt.errorbar(lrs, losses, yerr=loss_stds, marker="o", label=f"Model width {model_width}", capsize=3)
        else:
            ax.plot(lrs, losses, marker="o", label=f"Model width {model_width}")
            ax.errorbar(lrs, losses, yerr=loss_stds, marker="o", label=f"Model width {model_width}", capsize=3)
