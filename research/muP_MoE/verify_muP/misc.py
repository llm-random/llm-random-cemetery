...
def plot_module_grid(pivoted_dict, module_keyword, layer_num, step_interval=100, fig=None, ax=None):
    """
...
def plot_multiple_modules(activations_dict, module_keywords, layer_nums, dmodels, step_interval=100, figsize=(15, 10)):
    """
