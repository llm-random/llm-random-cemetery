...
def main(
    ...
    if data_distributed:
        ...
        torch.cuda.set_device(local_rank)
        print(f"Global rank: {global_rank}, Local rank: {local_rank}, Assigned device: {torch.cuda.current_device()}, Device count: {torch.cuda.device_count()}")
    ...
    print(f"Global rank: {global_rank}, Data seed: {data_seeds[global_rank]}, data seed kwarg: {common_dataloaders_kwargs['seed']}")
