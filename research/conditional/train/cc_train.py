...
def rogue_speedtest2(args):
    ...
    contmoe_1024 = ContinuousMoE(n_experts=1024, **common_args).cuda()
    contmoe_512 = ContinuousMoE(n_experts=512, **common_args).cuda()
    contmoe_256 = ContinuousMoE(n_experts=256, **common_args).cuda()
