...
def main(
    ...
    try:
        ...
        if rank is not None:
            ...
            init_process_group("nccl", init_method="env://", rank=rank, timeout=timedelta(seconds=10))
...
if __name__ == "__main__":
    ...
    main(rank=local_rank, [random.randint(0, 10000000) for _ in range(args.n_gpus)], args=args)
    if args.data_seed < 0:
        args.data_seed = random.randint(0, 10000000)
