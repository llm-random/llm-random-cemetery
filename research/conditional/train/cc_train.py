...
def main(
    ...
    param_grops_old, ratios_in_group_order_old = make_param_groups_and_lr_ratios(args, model)
    ...
    param_grops, ratios_in_group_order = make_param_groups_for_relative_lr(model, baseline_args, baseline_keys, relative_params_all)
