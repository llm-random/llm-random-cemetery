...
class ConditionalTrainer:
    ...
    def _before_train_operations(self):
        ...
        record_gpu_ram_availability(self.model_fits_filename, self.zipped_model_fits_params, False)

    def _after_train_operations(self):
        record_gpu_ram_availability(self.model_fits_filename, self.zipped_model_fits_params, True)
