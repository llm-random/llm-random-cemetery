...
from research.conditional.utils.check_model_fits import record_gpu_ram_availability
...
class ConditionalTrainer:
    ...
    def _before_train_operations(self):
        ...
        record_gpu_ram_availability(self.gpu_usage_report_path, self.gpu_usage_report_params, False)

    def _after_train_operations(self):
        record_gpu_ram_availability(self.gpu_usage_report_path, self.gpu_usage_report_params, True)
