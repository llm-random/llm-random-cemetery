...
class ConditionalTrainer:
    ...
    def __attrs_post_init__(self):
        ...
        if self.loaded_training_loop_accumulators:
            ...
            print(f"self.loaded_training_loop_accumulators[auxiliary_losses_accumulator].keys() {self.loaded_training_loop_accumulators["auxiliary_losses_accumulator"].keys()asd}")
