...
class ConditionalTrainer:
    ...
    def _eval_step(self, step: int):
        ...
        # print types of layers in layer_manager
        print(self.layer_manager._layers)
        print(f"types of layers in layer_manager: {[type(l) for _, l in self.layer_manager._layers]}")
