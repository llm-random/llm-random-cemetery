...
class ConditionalTrainer:
    ...
    def calculate_loss_and_gradient(self, processed_batch: LLMBatch):
        ...
        for i in range(self.gradient_accumulation_steps):
            ...
            print(f"RANK {self.rank}: GRAD ACC CHUNK NUMBER -> {i}")
            ...
            print(f"RANK {self.rank}: CROSS ENTROPY LOSS {cross_entropy_loss}")
            total_cross_entropy_loss += cross_entropy_loss
            print(f"RANK {self.rank}: TOTAL {total_cross_entropy_loss}")
