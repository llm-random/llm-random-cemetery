def check_args(args):
    ...
    assert args.n_rows_final_eval % args.final_eval_dataloader_batch_size == 0 and args.n_rows_final_eval > 0, "n_rows_final_eval must be a multiple of final_eval_dataloader_batch_size"
