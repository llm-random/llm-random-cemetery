...
def get_inner_expert(args):
    if args.moe_inner_expert == "ff":
        expert_inner_class = partial(ExpertFF, activation_name=args.activation_type, use_mock_gating_g=args.use_mock_gating_g)
        ...
        expert_inner_class = partial(ExpertGated, activation_name=args.activation_type, use_mock_gating_g=args.use_mock_gating_g)
        ...
        expert_inner_class = partial(
            ...
            clustering_iters=args.moe_clustering_iters, use_mock_gating_g=args.use_mock_gating_g,
        )
    ...
    # these experts names are left for backward compatibility
        ...
        expert_inner_class = partial(ExpertFF, activation_name="relu", use_mock_gating_g=args.use_mock_gating_g)
    elif args.moe_inner_expert == "swi_glu":
        expert_inner_class = partial(ExpertGated, activation_name="silu", use_mock_gating_g=args.use_mock_gating_g)
    elif args.moe_inner_expert == "geglu":
        expert_inner_class = partial(ExpertGated, activation_name="gelu", use_mock_gating_g=args.use_mock_gating_g)
    else:
        raise NotImplementedError(
