...
class ContinuousMoeBaseClass(LoggingLayer):
    ...
    def merge_process_profiling(self, x, merge_weights, emit_weights):
        ...
        for __ in range(20):
            ...
            inp1s = itertools.permutations(input_order_1.split()) #[input_order_1.split()]
            inp2s = [input_order_2.split()]#itertools.permutations(input_order_2.split()) #[input_order_2.split()] #
    ...
    def log_heavy(self):
        ...
        sanity_default = np.mean(self.logging_cache["time"]["merge_and_processB_S_g_dB_s_e_cd_e_fB_s_e_f"])
