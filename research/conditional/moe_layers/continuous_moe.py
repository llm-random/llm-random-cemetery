...
class ContinuousMoeBaseClass(LoggingLayer):
    ...
    def separate_map_emit(self, x, merge_weights, emit_weights):
        ...
        print(f" for {self.n_experts} experts, the shape of x is {x.shape} and lin1, lin2 are {self.lin1.shape}, {self.lin2.shape}")
    ...
    def init_parameters(self):
        ...
        self.lin2 = nn.Parameter(
            misc.get_init_weight(
                (self.n_experts,  self.dm, self.expert_size), fan_in=self.expert_size
            )
        )
