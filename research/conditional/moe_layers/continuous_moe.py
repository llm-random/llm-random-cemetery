...
class SpeedtestContMoE(nn.Module):
    ...
    def forward5(self, x, w=None, postmerge=None):
    ...
    def forward8(self, x, w, postmerge, postrearrange, postlin1, postlin2, postrearrange2, postemit):
    ...
    def forward7(self, x, w, postmerge, postrearrange, postlin1, postlin2, postrearrange2, postemit):
        x = misc.einsum(
            "B S c d, B S e c, e f d -> B S e f",
            x,
            w,
