...
class TokenizexTrainer:
    ...
    def _train_step(
        ...
        if self.is_logging_process:
            ...
            self._log_acc_time_stats(self.fb_time_byttok_loss, loss, step, int(self.fb_time_acc))
            self._log_acc_time_stats(self.fb_time_deftok_loss, aux_info["deftok_loss"], step, int(self.fb_time_acc))
