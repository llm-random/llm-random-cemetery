...
class LocalSearch:
    def __init__(self, server_name, base_config, iters, tune_params, wait_time=5, param_change=(0.2, 0.5, 1.5, 5), configs_directory="local_search_configs"):
        self.iters = iters
